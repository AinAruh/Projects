...
using IndustrialAssets.API.Middleware;
...
using IndustrialAssets.Infrastructure.Repositories;
...
builder.Services.AddDbContext<AssetsDbContext>(options =>
    options.UseNpgsql(builder.Configuration.GetConnectionString("AssetsDatabase")));
